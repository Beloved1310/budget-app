...
const UICtrl = (function () {
  ...
  return {
    ...
    getAgeInput: function () {
      return {
        ageInput: document.querySelector(UISelectors.age).value,
      };
    },
    getGenderInput: function () {
      return {
        genderInput: document.querySelector(UISelectors.gender).value,
      };
    },
    getMaritalStatusInput: function () {
      return {
        maritalstatusInput: document.querySelector(UISelectors.maritalstatus).value,
      };
    },
    getDependantsInput: function () {
      return {
        dependantsInput: document.querySelector(UISelectors.dependants).value,
      };
    },
    ...
    clearInputs: function () {
      ...
      document.querySelector(UISelectors.age).value = "";
      document.querySelector(UISelectors.gender).value = "";
      document.querySelector(UISelectors.maritalstatus).value = "";
      document.querySelector(UISelectors.dependants).value = "";
    },
...
const App = (function () {
  ...
  const addIncome = function () {
    ...
    const age = UICtrl.getAgeInput();
    const amount = UICtrl.getValueInput();
    const gender = UICtrl.getGenderInput();
    const maritalstatus = UICtrl.getMaritalStatusInput();
    const dependants = UICtrl.getDependantsInput();
